...
<head>
    ...
    <style>
        .category-badge-sightseeing { background-color: #0d6efd; }
        .category-badge-food { background-color: #fd7e14; }
        .category-badge-adventure { background-color: #198754; }
    </style>
</head>
<body class="bg-light">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <a href="city-search.php" class="btn btn-outline-light btn-sm">City Search</a>
        </div>
    </div>
</nav>
            ...
            <?php foreach ($filtered_activities as $index => $activity): ?>
                <div class="col-md-4 col-lg-3">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            <span class="badge category-badge-<?php echo $activity['category']; ?> mb-2">
                                <?php echo ucfirst($activity['category']); ?>
                            </span>
                            <h5 class="card-title"><?php echo htmlspecialchars($activity['name']); ?></h5>
                            <p class="mb-1">💰 ₹<?php echo number_format($activity['cost']); ?></p>
                            <p class="mb-3">⏱ <?php echo $activity['duration']; ?> hr(s)</p>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <hr>
                                <p class="mb-1"><strong>Category:</strong> <?php echo ucfirst($activity['category']); ?></p>
                                <p class="mb-1"><strong>Cost:</strong> ₹<?php echo number_format($activity['cost']); ?></p>
                                <p class="mb-0"><strong>Duration:</strong> <?php echo $activity['duration']; ?> hour(s)</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Don't see your city? Add it first from City Search.</small>
                                    </div>
                                </div>
